...
<body>
    ...
    <main class="my-3 mx-5 px-5 d-flex flex-column align-items-center">
        <form action="inscription.php" method="POST">
            ...
            <input class="form-group btn btn-success mt-2 mx-2 rounded-pill" type="submit" name="reg_user" value="Register">
            <p>
                Already a member? <a href="connexion.php" class="form-group btn btn-success mt-2 mx-2 rounded-pill">Sign in</a>
            </p>
        </form>
    </main>
