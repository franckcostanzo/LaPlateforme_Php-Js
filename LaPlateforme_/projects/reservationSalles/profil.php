    ...
    <main class="my-3 mx-5 px-5 d-flex flex-column align-items-center">
        ...
        ?>
            <form action="profil.php" method="POST">
                ...
                <input class="form-group btn btn-danger mt-2 mx-2 rounded-pill" type="submit" name="pwd_chg" value="Change Password">
            </form>
        <?php  }
            else
            {
        ?>
            ...
            <p>
                Pas encore membre ? <a href="inscription.php"  class="form-group btn btn-danger mt-2 mx-2 rounded-pill" id="registerGrp">Sign up</a>
            </p>
        <?php
            }
        ?>
